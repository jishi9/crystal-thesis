...
\caption{A mesh with the original cell numbering shown. The numbers on unstructured cells are omitted.}
\label{fig:original-numbering}
\end{figure}

\begin{figure}
\includesvg[width=\imagewidth, svgpath=images/renumbering/]{fringe-cells-renumbered}
\caption{A mesh with the Crystal cell numbering shown. The numbers on unstructured cells are omitted.}
