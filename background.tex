...
\includesvg[scale=0.5, svgpath=images/background/]{mesh-elements}
...
\begin{figure}
    \includesvg[scale=0.5, svgpath=images/background/]{same-topology}
...
\begin{figure}
    \sidebyside
        {\includesvg[scale=0.2, svgpath=images/background/]{closed-fan}
        \caption{A closed fan}}
        {\includesvg[scale=0.2, svgpath=images/background/]{open-fan}
        \caption{An open fan}}
    \caption{}
...
\begin{figure}
    \sidebysidefour
    {\includesvg[scale=0.2, svgpath=images/background/]{bad-fan}
        \caption{Faces incident on a vertex which do not form a continuous fan}}
    {\includesvg[scale=0.2, svgpath=images/background/]{bad-fan2}
        \caption{An extra face that breaks off from the otherwise closed fan}}
    {\includesvg[scale=0.8, svgpath=images/background/]{bad-multi-edge}
        \caption{More than two faces incident on a single edge}}
    {\includesvg[scale=0.8, svgpath=images/background/]{bad-no-edge}
...
\begin{figure}
    \includesvg[scale=2, svgpath=images/background/]{mesh-data-structure}
...
\begin{figure}
    \includesvg[scale=4, svgpath=images/background/]{entity-sets}
...
\begin{figure}
    \includesvg[scale=4, svgpath=images/background/]{associative-data}
...
\begin{figure}
    \includesvg[scale=4, svgpath=images/background/]{relation}
