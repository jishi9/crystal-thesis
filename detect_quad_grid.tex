...
\subsection{Phase 5: Extend rows}
%% Phase 5.1 summary
...
\begin{tikzpicture}
	...
	% Mid rows
	\drawellipsiscol{num=3, coloffset=7.5}
	\drawgrid{rows=3, cols=3,
		labeler=\varrowlabelnode, labelerA=0, labelerB=0, labelerC=i,
		northborder=structured, eastborder=structured}
	\drawgrid{rows=3, cols=1, coloffset=8,
		labeler=\varlabelnode, labelerA=0, labelerB=0, labelerC=i, labelerD=c,
...
\begin{tikzpicture}
	...
	% Mid rows
	\drawellipsiscol{num=3, coloffset=7.5}
	\drawgrid{rows=3, cols=3, labeler=\varrowlabelnode, labelerA=0, labelerB=0, labelerC=i,
		northborder=structured, eastborder=structured}
	\drawgrid{rows=3, cols=1, coloffset=8, labeler=\varlabelnode, labelerA=0, labelerB=0, labelerC=i, labelerD=c,
		northborder=structured, westborder=structured, southborder=structured, eastborder=structured}

	% Bottom horizontal ellipsis
	\drawellipsisrow{num=3, rowoffset=-7.5}
	\drawellipsisrow{num=1, rowoffset=-7.5, coloffset=8}

	% Last row
	\drawgrid{rows=1, cols=3, rowoffset=-8, labeler=\varrowlabelnode, labelerA=0, labelerB=0, labelerC=r,
		northborder=structured, eastborder=structured}
	\drawgrid{rows=1, cols=1, rowoffset=-8, coloffset=8, labeler=\varlabelnode, labelerA=0, labelerB=0, labelerC=r, labelerD=c,
		northborder=structured, westborder=structured}
\end{tikzpicture}
...
% 	\coordinate (westup) at (-1,1);		\node (r1c1) at (0,1) {$n_{i,1}$};		\node (r1c2) at (2,1) {$n_{i,2}$};		\node (r1c3) at (4,1) {$n_{i,3}$};		\coordinate (eastup) at (5,1);
% 	\coordinate (westmid) at (-1,-1);	\node (r2c1) at (0,-1) {$n_{i+1,1}$};	\node (r2c2) at (2,-1) {$n_{i+1,2}$};	\node (r2c3) at (4,-1) {$n_{i+1,3}$};	\coordinate (eastmid) at (5,-1);
% 	\coordinate (westdown) at (-1,-3);	\node (r3c1) at (0,-3) {$n_{i+2,1}$};	\node (r3c2) at (2,-3) {$n_{i+2,2}$};	\node (r3c3) at (4,-3) {$n_{i+2,3}$};	\coordinate (eastdown) at (5,-3);
% 										\coordinate (southleft) at (0, -4);		\coordinate (southmid) at (2, -4);		\coordinate (southright) at (4, -4);

% 	% ellipses
% 	\coordinate (ellipsis westup) at (5,1);		\coordinate (ellipsis eastup) at (5.5,1);
% 	\coordinate (ellipsis westmid) at (5,-1);	\coordinate (ellipsis eastmid) at (5.5,-1);
% 	\coordinate (ellipsis westdown) at (5,-3);	\coordinate (ellipsis eastdown) at (5.5,-3);
...
% 	\coordinate (rhs westup) at (6,1);		\node (r1cn) at (7,1) {$n_{i,c}$};		\coordinate (rhs eastup) at (8,1);
% 	\coordinate (rhs westmid) at (6,-1);	\node (r2cn) at (7,-1) {$n_{i+1,c}$};	\coordinate (rhs eastmid) at (8,-1);
% 	\coordinate (rhs westdown) at (6,-3);	\node (r3cn) at (7,-3) {$n_{i+2,c}$};	\coordinate (rhs eastdown) at (8,-3);
% 											\coordinate (rhs south) at (7, -4);
